 ...
 * on 2016-08-14 at 19:52:15 UTC 
 * Modify at your own risk.
 */

package com.catalize.backend.model.userApi;
...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetUser extends UserApiRequest<com.catalize.backend.model.userApi.model.User> {
    ...
    protected GetUser(java.lang.Long id) {
      super(UserApi.this, "GET", REST_PATH, null, com.catalize.backend.model.userApi.model.User.class);
   ...
   *
   * @param content the {@link com.catalize.backend.model.userApi.model.User}
   * @return the request
   */
  public InsertUser insertUser(com.catalize.backend.model.userApi.model.User content) throws java.io.IOException {
    InsertUser result = new InsertUser(content);
    initialize(result);
    return result;
  }

  public class InsertUser extends UserApiRequest<com.catalize.backend.model.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected InsertUser(com.catalize.backend.model.userApi.model.User content) {
      super(UserApi.this, "POST", REST_PATH, content, com.catalize.backend.model.userApi.model.User.class);
    }
